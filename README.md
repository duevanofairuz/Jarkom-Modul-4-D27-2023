...
### 1. VLSM (CPT)
![Alt text](img/image-5.png)<br><br><br>
...
### 2. CIDR (GNS3)
![Alt text](img/image-47.png)<br><br>
...
* Frieren: <br>
![Alt text](img/image-63.png)<br>
* Aura: <br>
![Alt text](img/image-64.png)<br>
* Denken: <br>
![Alt text](img/image-65.png)<br>
* Eisen: <br>
